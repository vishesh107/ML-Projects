{
 "cells": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "100%|█████████▉| 1432/1433 [05:27<00:00,  4.37it/s]\n"
     ]
    },
    {
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "final_df.drop(columns=[\"meta.data_version\",\"meta.created\",\"meta.revision\",\"info.outcome.by.wickets\",\"info.player_of_match\",\"info.match_type_number\",\"info.supersubs.South Africa\",\"info.supersubs.New Zealand\",\"info.neutral_venue\",\"info.outcome.method\",\"info.outcome.result\",\"info.bowl_out\",\"info.outcome.bowl_out\"],inplace=True)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0         male             T20           Sri Lanka          20   \n",
       "0         male             T20           Australia          20   \n",
       "0         male             T20           Hong Kong          20   \n",
       "0         male             T20            Zimbabwe          20   \n",
       "..         ...             ...                 ...         ...   \n",
       "0         male             T20            Pakistan          20   \n",
       "0         male             T20               India          20   \n",
       "0         male             T20         Netherlands          20   \n",
       "0         male             T20           Australia          20   \n",
       "0         male             T20           Australia          20   \n",
       "\n",
       ...
       "\n",
       "    info.outcome.by.runs info.outcome.eliminator  \n",
       "0                    NaN                     NaN  \n",
       "0                    NaN                     NaN  \n",
       "0                   41.0                     NaN  \n",
       "0                   40.0                     NaN  \n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\sharm\\Anaconda3\\lib\\site-packages\\pandas\\core\\frame.py:4308: SettingWithCopyWarning: \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0  [{'1st innings': {'team': 'Australia', 'delive...  [2017-02-17]   \n",
       "\n",
       "  info.match_type info.outcome.winner  info.overs              info.teams  \\\n",
       "0             T20           Sri Lanka          20  [Australia, Sri Lanka]   \n",
       "\n",
       "  info.toss.decision info.toss.winner            info.umpires  \\\n",
       "0              field        Sri Lanka  [MD Martell, P Wilson]   \n",
       "\n",
       "                 info.venue  match_id info.city  info.outcome.by.runs  \\\n",
       "0  Melbourne Cricket Ground         1       NaN                   NaN   \n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0   [{'1st innings': {'team': 'Sri Lanka', 'delive...  [2016-09-09]   \n",
       "\n",
       "   info.match_type info.outcome.winner                           info.teams  \\\n",
       "0              T20           Sri Lanka               [Australia, Sri Lanka]   \n",
       "0              T20           Sri Lanka               [Australia, Sri Lanka]   \n",
       "0              T20           Australia               [Australia, Sri Lanka]   \n",
       "0              T20           Hong Kong                 [Ireland, Hong Kong]   \n",
       "0              T20            Zimbabwe                    [Zimbabwe, India]   \n",
       "..             ...                 ...                                  ...   \n",
       "0              T20            Pakistan                [Pakistan, Sri Lanka]   \n",
       "0              T20               India                  [Bangladesh, India]   \n",
       "0              T20         Netherlands  [United Arab Emirates, Netherlands]   \n",
       "0              T20           Australia               [Sri Lanka, Australia]   \n",
       "0              T20           Australia               [Sri Lanka, Australia]   \n",
       "\n",
       ...
       "0               field              Pakistan   \n",
       "0               field                 India   \n",
       "0               field  United Arab Emirates   \n",
       "0               field             Sri Lanka   \n",
       "0                 bat             Sri Lanka   \n",
       "\n",
       "                          info.umpires  \\\n",
       "0               [MD Martell, P Wilson]   \n",
       "0                [SD Fry, SJ Nogajski]   \n",
       "0               [MD Martell, P Wilson]   \n",
       "0                  [R Black, AJ Neill]   \n",
       "0             [TJ Matibiri, RB Tiffin]   \n",
       "..                                 ...   \n",
       "0         [AK Chaudhary, Enamul Haque]   \n",
       "0     [RSA Palliyaguruge, Shozab Raza]   \n",
       "0           [CK Nandan, Sarika Prasad]   \n",
       "0       [REJ Martinesz, RR Wimalasiri]   \n",
       "0   [REJ Martinesz, RSA Palliyaguruge]   \n",
       "\n",
       "                                 info.venue  match_id    info.city  \\\n",
       "0                  Melbourne Cricket Ground         1          NaN   \n",
       "0            Simonds Stadium, South Geelong         2     Victoria   \n",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {2.2: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {2.3: {'batsman': 'M Klinger',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {2.4: {'batsman': 'M Klinger',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {2.5: {'batsman': 'M Klinger',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 4, 'extras': 0, 'total': 4}}},\n",
       " {2.6: {'batsman': 'M Klinger',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {3.1: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {3.2: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       ...
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 4, 'extras': 0, 'total': 4}}},\n",
       " {4.4: {'batsman': 'M Klinger',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 4, 'extras': 0, 'total': 4}}},\n",
       " {4.5: {'batsman': 'M Klinger',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {4.6: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {5.1: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {5.2: {'batsman': 'M Klinger',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'extras': {'wides': 1},\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 1, 'total': 1}}},\n",
       " {5.3: {'batsman': 'M Klinger',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {5.4: {'batsman': 'M Klinger',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {5.5: {'batsman': 'M Klinger',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {5.6: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {5.7: {'batsman': 'M Klinger',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {6.1: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {6.2: {'batsman': 'M Klinger',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {6.3: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {6.4: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {6.5: {'batsman': 'M Klinger',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {6.6: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {7.1: {'batsman': 'M Klinger',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       ...
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 1, 'total': 1}}},\n",
       " {7.5: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 4, 'extras': 0, 'total': 4}}},\n",
       " {7.6: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {8.1: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       ...
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 3, 'extras': 0, 'total': 3}}},\n",
       " {8.3: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {8.4: {'batsman': 'M Klinger',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       ...
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {8.6: {'batsman': 'M Klinger',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {9.1: {'batsman': 'M Klinger',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {9.2: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {9.3: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {9.4: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {9.5: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 6, 'extras': 0, 'total': 6}}},\n",
       " {9.6: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {10.1: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {10.2: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'extras': {'legbyes': 1},\n",
       "   'non_striker': 'M Klinger',\n",
       "   'runs': {'batsman': 0, 'extras': 1, 'total': 1}}},\n",
       " {10.3: {'batsman': 'M Klinger',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0},\n",
       "   'wicket': {'fielders': ['SL Malinga'],\n",
       "    'kind': 'caught',\n",
       "    'player_out': 'M Klinger'}}},\n",
       " {10.4: {'batsman': 'TM Head',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {10.5: {'batsman': 'TM Head',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {10.6: {'batsman': 'TM Head',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'AJ Finch',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {11.1: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'DAS Gunaratne',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 6, 'extras': 0, 'total': 6}}},\n",
       " {11.2: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'DAS Gunaratne',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {11.3: {'batsman': 'AJ Finch',\n",
       "   'bowler': 'DAS Gunaratne',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0},\n",
       "   'wicket': {'fielders': ['SL Malinga'],\n",
       ...
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {11.6: {'batsman': 'TM Head',\n",
       "   'bowler': 'DAS Gunaratne',\n",
       "   'non_striker': 'MC Henriques',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {12.1: {'batsman': 'TM Head',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'MC Henriques',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {12.2: {'batsman': 'TM Head',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'MC Henriques',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {12.3: {'batsman': 'MC Henriques',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {12.4: {'batsman': 'TM Head',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'MC Henriques',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {12.5: {'batsman': 'TM Head',\n",
       "   'bowler': 'S Prasanna',\n",
       "   'non_striker': 'MC Henriques',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       ...
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {13.1: {'batsman': 'MC Henriques',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {13.2: {'batsman': 'MC Henriques',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'extras': {'wides': 1},\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 0, 'extras': 1, 'total': 1}}},\n",
       " {13.3: {'batsman': 'MC Henriques',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {13.4: {'batsman': 'TM Head',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'MC Henriques',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       ...
       "   'non_striker': 'MC Henriques',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {14.2: {'batsman': 'MC Henriques',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 3, 'extras': 0, 'total': 3}}},\n",
       " {14.3: {'batsman': 'TM Head',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'MC Henriques',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       ...
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 6, 'extras': 0, 'total': 6}}},\n",
       " {14.5: {'batsman': 'MC Henriques',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 3, 'extras': 0, 'total': 3}}},\n",
       " {14.6: {'batsman': 'TM Head',\n",
       "   'bowler': 'PADLR Sandakan',\n",
       "   'non_striker': 'MC Henriques',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       ...
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0},\n",
       "   'wicket': {'fielders': ['CK Kapugedera'],\n",
       "    'kind': 'caught',\n",
       "    'player_out': 'MC Henriques'}}},\n",
       " {15.2: {'batsman': 'TM Head',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       ...
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {15.5: {'batsman': 'TM Head',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {15.6: {'batsman': 'TM Head',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'extras': {'wides': 1},\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 0, 'extras': 1, 'total': 1}}},\n",
       " {15.7: {'batsman': 'TM Head',\n",
       "   'bowler': 'JRMVB Sanjaya',\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 6, 'extras': 0, 'total': 6}}},\n",
       " {16.1: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {16.2: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 4, 'extras': 0, 'total': 4}}},\n",
       " {16.3: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {16.4: {'batsman': 'TM Head',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {16.5: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {16.6: {'batsman': 'TM Head',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {17.1: {'batsman': 'TM Head',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {17.2: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {17.3: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'extras': {'noballs': 1},\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 0, 'extras': 1, 'total': 1}}},\n",
       " {17.4: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {17.5: {'batsman': 'TM Head',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {17.6: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {17.7: {'batsman': 'TM Head',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {18.1: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {18.2: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'TM Head',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {18.3: {'batsman': 'TM Head',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {18.4: {'batsman': 'TM Head',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'AJ Turner',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0},\n",
       "   'wicket': {'fielders': ['S Prasanna'],\n",
       "    'kind': 'caught',\n",
       "    'player_out': 'TM Head'}}},\n",
       " {18.5: {'batsman': 'AJ Turner',\n",
       "   'bowler': 'SL Malinga',\n",
       ...
       " {18.6: {'batsman': 'JP Faulkner',\n",
       "   'bowler': 'SL Malinga',\n",
       "   'non_striker': 'TD Paine',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1}}},\n",
       " {19.1: {'batsman': 'JP Faulkner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'TD Paine',\n",
       "   'runs': {'batsman': 4, 'extras': 0, 'total': 4}}},\n",
       " {19.2: {'batsman': 'JP Faulkner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'TD Paine',\n",
       "   'runs': {'batsman': 0, 'extras': 0, 'total': 0}}},\n",
       " {19.3: {'batsman': 'JP Faulkner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'TD Paine',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {19.4: {'batsman': 'JP Faulkner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'extras': {'wides': 1},\n",
       "   'non_striker': 'TD Paine',\n",
       "   'runs': {'batsman': 0, 'extras': 1, 'total': 1}}},\n",
       " {19.5: {'batsman': 'JP Faulkner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'TD Paine',\n",
       "   'runs': {'batsman': 1, 'extras': 0, 'total': 1},\n",
       "   'wicket': {'fielders': ['CK Kapugedera', 'KMDN Kulasekara'],\n",
       "    'kind': 'run out',\n",
       "    'player_out': 'TD Paine'}}},\n",
       " {19.6: {'batsman': 'JP Faulkner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'PJ Cummins',\n",
       "   'runs': {'batsman': 2, 'extras': 0, 'total': 2}}},\n",
       " {19.7: {'batsman': 'JP Faulkner',\n",
       "   'bowler': 'KMDN Kulasekara',\n",
       "   'non_striker': 'PJ Cummins',\n",
       "   'runs': {'batsman': 4, 'extras': 0, 'total': 4}}}]"
      ]
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "..          ...   ...              ...      ...                       ...  \n",
       "121    MA Starc     1                0  Colombo       R Premadasa Stadium  \n",
       "122    MA Starc     0                0  Colombo       R Premadasa Stadium  \n",
       "123    MA Starc     0      DM de Silva  Colombo       R Premadasa Stadium  \n",
       "124    MA Starc     2                0  Colombo       R Premadasa Stadium  \n",
       "125    MA Starc     1                0  Colombo       R Premadasa Stadium  \n",
       "\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "delivery_df[\"balling_team\"]=delivery_df.apply(ball,axis=1)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "delivery_df=delivery_df[delivery_df[\"balling_team\"].isin(team)]"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "  </tbody>\n",
       "</table>\n",
       "<p>63888 rows × 10 columns</p>\n",
       "</div>"
      ],
      "text/plain": [
       "     match_id batting_team  ball          batsman      bowler  runs  \\\n",
       "0           2    Australia   0.1         AJ Finch  SL Malinga     0   \n",
       "1           2    Australia   0.2         AJ Finch  SL Malinga     0   \n",
       "2           2    Australia   0.3         AJ Finch  SL Malinga     1   \n",
       "3           2    Australia   0.4        M Klinger  SL Malinga     2   \n",
       "4           2    Australia   0.5        M Klinger  SL Malinga     0   \n",
       "..        ...          ...   ...              ...         ...   ...   \n",
       "121       964    Sri Lanka  19.3  SMSM Senanayake    MA Starc     1   \n",
       "122       964    Sri Lanka  19.4      DM de Silva    MA Starc     0   \n",
       "123       964    Sri Lanka  19.5      DM de Silva    MA Starc     0   \n",
       "124       964    Sri Lanka  19.6  SMSM Senanayake    MA Starc     2   \n",
       "125       964    Sri Lanka  19.7  SMSM Senanayake    MA Starc     1   \n",
       "\n",
       "    player_dismissed     city                     venue balling_team  \n",
       "0                  0      NaN  Melbourne Cricket Ground    Sri Lanka  \n",
       "1                  0      NaN  Melbourne Cricket Ground    Sri Lanka  \n",
       "2                  0      NaN  Melbourne Cricket Ground    Sri Lanka  \n",
       "3                  0      NaN  Melbourne Cricket Ground    Sri Lanka  \n",
       "4                  0      NaN  Melbourne Cricket Ground    Sri Lanka  \n",
       "..               ...      ...                       ...          ...  \n",
       "121                0  Colombo       R Premadasa Stadium    Australia  \n",
       "122                0  Colombo       R Premadasa Stadium    Australia  \n",
       "123      DM de Silva  Colombo       R Premadasa Stadium    Australia  \n",
       "124                0  Colombo       R Premadasa Stadium    Australia  \n",
       "125                0  Colombo       R Premadasa Stadium    Australia  \n",
       "\n",
       "[63888 rows x 10 columns]"
      ]
     },
     "execution_count": 146,
     "metadata": {},
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "output = delivery_df[['match_id','batting_team','balling_team','ball','runs','player_dismissed','city','venue']]"
   ]
  },
  {
   "cell_type": "code",
